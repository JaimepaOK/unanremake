    ...
    <b-navbar toggleable="lg" type="dark" variant="info">
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown v-for="item in items" :key="item" right>
            <!-- Using 'button-content' slot -->
            <template #button-content>
              <div>{{ item.info }}</div>
            </template>

			<div v-if="item.info === 'INSTITUCIÓN'">
				<div v-for="item2 in items2" :key="item2">
            ...
            <div v-else-if="item.info === 'ACADEMICA'">
              <div v-for="item3 in items3" :key="item3">
			...
			<div v-else-if="item.info === 'INVESTIGACIÓN y PROYECCIÓN'">
              <div v-for="item4 in items4" :key="item4">
			...
			<div v-else-if="item.info === 'RELACIONES EXTERNAS'">
              <div v-for="item5 in items5" :key="item5">
  ...
  data() {
    return {
      ...
      items3: [
		...
		{ data: 'Reforma del Reglamento del Sistema de Créditos Académicos.', ref: '#'}
      ],
      items4: [
        { data: 'Presentación VIPS', ref: '#' },
        { data: 'Potencialidades de la UNAN-León', ref: '#' },
        { data: 'Portal de Revistas Científica y Literaria', ref: '#' },
        { data: 'Normativas Editoriales de la Revista Científica de la UNAN-León', ref: '#' },
        { data: 'Catálogo de Laboratorios de la UNAN-León.', ref: '#' },
        { data: 'Guía de Presentación de Proyectos de Investigación', ref: '#' },
        { data: 'Reglamento: Jornada Universitaria de Desarrollo Científico, JUDC', ref: '#' },
      ...
      items5: [
        ...
        { data: 'Políticas de Cooperación y el Comité de Cooperación Externa CCE.', ref: '#' },
        { data: 'Servicios Prestados - Tramites Migratorios', ref: '#' },
        { data: 'Equipo de Trabajo y Organigrama de VRE', ref: '#' },
		{ data: 'Convocatorias de Postgrado: Maestría - Doctorado - Varias', ref:"#"},
